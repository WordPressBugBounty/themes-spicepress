			...
			$wp_customize->add_control(
				new Spicepress_Header_Logo_Customize_Control_Radio_Image(
					$wp_customize, 'header_logo_placing', array(
						...
						'choices' => array(
							'left' => array(
								'url' => trailingslashit( ST_TEMPLATE_DIR_URI ) . 'free/images/header-left.png',
							),
							'right' => array(
								'url' => trailingslashit( ST_TEMPLATE_DIR_URI ) . 'free/images/header-right.png',
							),
							'center' => array(
								'url' => trailingslashit( ST_TEMPLATE_DIR_URI ) . 'free/images/header-center.png',
							),
						),
					)
				)
