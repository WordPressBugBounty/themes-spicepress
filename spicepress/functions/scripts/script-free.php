...
if( !function_exists('spicepress_scripts_function'))
{
	function spicepress_scripts_function(){
		...
		{
	        wp_enqueue_style('spicepress-default', ST_TEMPLATE_DIR_URI . '/css/default-free.css');
		}
		
		// css
		wp_enqueue_style('bootstrap', ST_TEMPLATE_DIR_URI . '/css/bootstrap.css');
		wp_style_add_data( 'bootstrap', 'rtl-free', 'replace' );
		wp_enqueue_style('spicepress-style', ST_TEMPLATE_DIR_URI . '/css/style-free.css' );
		...
		wp_enqueue_style('spicepress-media-responsive-css', ST_TEMPLATE_DIR_URI . '/css/media-responsive-free.css');
                wp_style_add_data( 'spicepress-media-responsive-css', 'rtl-free', 'replace' );		
		...
		// Menu & page scroll js
		wp_enqueue_script('spicepress-menu-free-js', ST_TEMPLATE_DIR_URI . '/js/menu/menu-free.js');
		...
		wp_localize_script('spicepress-menu-free-js','breakpoint_settings',$breakpoint_settings);
        wp_enqueue_script('spicepress-menu-free-js');
